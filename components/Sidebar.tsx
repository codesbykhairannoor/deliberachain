    ...
    <aside className="fixed left-0 top-0 h-screen w-64 bg-[#050505] border-r border-white/5 flex flex-col z-50">
      ...
      <div className="p-8">
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <span className="text-lg font-black text-foreground tracking-tighter uppercase italic">Dlibra<span className="text-vault-amber">tion</span></span>
        </Link>
      </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    <item.icon size={18} className={isActive ? "text-vault-amber" : "text-muted-foreground"} />
