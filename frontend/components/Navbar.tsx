      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <Link href="/" className="flex items-center gap-3 cursor-pointer group">
          ...
          <h1 className="text-xl font-black tracking-tighter text-white uppercase flex items-center">
            DELIBERATE<span className="text-vault-amber">CHAIN</span>
        ...
        <div className="flex items-center gap-3">
          ...
          <ConnectButton client={client} theme="dark" connectButton={{ className: "!bg-white/10 !hover:bg-white/20 !border !border-white/10 !text-sm !font-bold !px-4 !py-2 !rounded-lg" }} />
        </div>
      </div>
    </nav>
  );
