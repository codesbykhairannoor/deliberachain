      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-32">
            <motion.h1 
                ...
                className="text-5xl md:text-8xl font-black tracking-[-0.03em] leading-[1.05] text-foreground mb-8"
            >
            ...
            <motion.p 
                ...
                className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto opacity-80"
            >
        ...
        <div className="relative group mb-40">
            ...
            <div className="relative aspect-video bg-vault-card border border-white/10 rounded-[3rem] overflow-hidden flex items-center justify-center shadow-2xl">
                ...
                <div className="absolute bottom-12 left-12 z-20 flex items-center gap-4">
                    ...
                    <span className="text-xs font-black uppercase tracking-widest text-foreground">Live Platform Demo (1:45)</span>
                </div>
            </div>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="bg-black border border-white/10 rounded-[2.5rem] overflow-hidden">
                    <div className="bg-white/5 px-8 py-4 border-b border-white/10 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <span className="text-xs font-black uppercase tracking-widest text-muted-foreground">Blockchain Explorer Simulator</span>
                        </div>
                    ...
                    <div className="p-8 font-mono text-sm space-y-4">
                        ...
                        <div className="flex gap-4 text-muted-foreground animate-pulse"><span className="opacity-40">0x...</span> <span>Awaiting next block confirmation...</span></div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-vault-card border border-white/5 p-10 rounded-[2.5rem] flex flex-col justify-between">
                <div>
                    <h3 className="text-2xl font-bold text-foreground mb-4">Uji Coba Langsung?</h3>
