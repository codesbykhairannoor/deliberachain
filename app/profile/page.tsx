...
export default function ProfilePage() {
  ...
  if (!account) return <div className="p-20 text-white">Please Connect Wallet</div>;
    ...
    <div className="animate-in fade-in duration-500">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 mb-16 pb-16 border-b border-white/5">
            ...
            <div className="text-center md:text-left flex-1">
                <h1 className="text-4xl font-black text-white mb-2 tracking-tight">Citizen #{account.address.substring(38)}</h1>
                <p className="text-slate-500 font-mono text-sm bg-white/5 px-2 py-1 rounded inline-block">
                    {account.address}
                </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <div className="md:col-span-7 space-y-6">
                <h3 className="text-lg font-bold text-white flex items-center gap-2 mb-4">
                    <History size={20} className="text-slate-500" /> Recent Participation
                </h3>
                ...
                {[1, 2, 3].map(i => (
                    ...
                    >
                        <div>
                            <p className="text-sm font-bold text-white">Voted on: Perbaikan Aspal Jl. Sudirman</p>
                            <p className="text-[10px] text-slate-500 uppercase mt-1">Transaction Hash: 0xef34...456</p>
                        </div>
                        <Globe size={16} className="text-slate-600 group-hover:text-vault-amber" />
                    </motion.div>
                ))}
            </div>
