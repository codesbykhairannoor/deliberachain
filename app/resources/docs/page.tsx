        ...
        <div className="text-center max-w-4xl mx-auto mb-32">
            ...
            <div className="relative max-w-2xl mx-auto">
                ...
                <input 
                    ...
                    className="w-full bg-white/5 border border-white/10 p-6 pl-16 rounded-2xl text-white outline-none focus:border-vault-amber transition-all font-bold"
                />
            </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
            {[
                ...
                <div key={i} className="p-12 bg-vault-card border border-white/5 rounded-[3rem] hover:border-vault-amber/30 transition-all group">
                    ...
                    <p className="text-slate-500 font-medium mb-8 leading-relaxed">{card.desc}</p>
                    <button className="text-xs font-black uppercase tracking-widest text-white border-b border-vault-amber pb-1">Read Docs</button>
                </div>
            ))}
        </div>
      </div>
