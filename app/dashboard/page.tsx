...
export default function DashboardPage() {
  ...
  const dashboardT = {
    id: {
        ...
        feedTitle: "Garis Waktu",
        roomTitle: "Ruang Deliberasi",
        kritikTitle: "Kritik & Saran",
        formTitle: "Suara Rakyat",
        globalFeed: "Feed Deliberasi Global",
    ...
    en: {
        ...
        discoveryTitle: "Discovery",
        feedTitle: "My Timeline",
        roomTitle: "Deliberation Room",
        kritikTitle: "Criticism & Feedback",
        formTitle: "Voice of the People",
        globalFeed: "Global Deliberation Feed",
